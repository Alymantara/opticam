...
setup(
  ...
  description = 'Software for OPTICam/SPM Observatory',   # Give a short description about your library
  author = 'Juan Hernandez Santisteban',                   # Type in your name
  author_email = 'jvhs1@st-andrews.ac.uk',      # Type in your E-Mail
